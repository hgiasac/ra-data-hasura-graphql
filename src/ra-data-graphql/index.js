...
import { GET_LIST, GET_ONE, GET_MANY, GET_MANY_REFERENCE, CREATE, UPDATE, DELETE, DELETE_MANY, UPDATE_MANY, sanitizeFetchType } from 'ra-core';
...
export default (function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, clientObject, clientOptions, introspection, resolveIntrospection, buildQueryFactory, _b, override, otherOptions, client, introspectionResults, buildQuery, handle;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                handle = function (aorFetchType, resource, params) {
                    var overriddenBuildQuery = get(override, resource + "." + sanitizeFetchType(aorFetchType));
                ...
                // raDataProvider.saga = () => {};
                return [2 /*return*/, {
                        getList: function (resource, params) { return handle(GET_LIST, resource, params); },
                        getOne: function (resource, params) { return handle(GET_ONE, resource, params); },
                        getMany: function (resource, params) { return handle(GET_MANY, resource, params); },
                        getManyReference: function (resource, params) {
                            return handle(GET_MANY_REFERENCE, resource, params);
                        },
                        update: function (resource, params) { return handle(UPDATE, resource, params); },
                        updateMany: function (resource, params) {
                            return handle(UPDATE_MANY, resource, params);
                        },
                        ...
                        deleteMany: function (resource, params) {
                            return handle(DELETE_MANY, resource, params);
                        },
                    }];
        }
    });
